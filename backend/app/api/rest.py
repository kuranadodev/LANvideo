...
def current_settings(request: Request | None = None) -> AppSettings:
    return AppSettings(
        ...
        video_analysis_fps=settings.video_analysis_fps,
        video_pipeline_mode=settings.video_pipeline_mode,
        ...
        video_maxrate=settings.video_maxrate,
        video_bufsize=settings.video_bufsize,
        video_thread_queue_size=settings.video_thread_queue_size,
        audio_thread_queue_size=settings.audio_thread_queue_size,
        video_rtsp_transport=settings.video_rtsp_transport,
        video_low_latency_mode=settings.video_low_latency_mode,
        video_analysis_width=settings.video_analysis_width,
        video_analysis_height=settings.video_analysis_height,
