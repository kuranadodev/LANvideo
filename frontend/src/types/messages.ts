...
export type EventMessage =
  | { type: 'video.metrics'; timestamp: number; fps: number; frame_index: number; algorithm_ms: number; width: number; height: number }
  | { type: 'detection.boxes'; timestamp: number; frame_index: number; boxes: Box[] }
